          ...
          <div class="photo-upload__meta">
            ...
            <template v-else>
              ...
              <div class="photo-upload__geocode">
                ...
                >
                  <li
                    v-if="geocodeLoading[item.key]"
                    class="photo-upload__geocode-item photo-upload__geocode-item--muted"
                  >
                    搜尋中…
                  </li>
                  <li
              ...
              >
                {{ item.placeName }} · {{ formatCoord(item.lat) }}，{{
                  formatCoord(item.lng)
                }}
              </span>
            </template>
          </div>
...
function onGeocodeInput(item: LocalPendingPhotoItem, value: string) {
...
function selectGeocodeResult(item: LocalPendingPhotoItem, feature: NominatimGeocodeResult) {
